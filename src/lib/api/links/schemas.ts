 ...
 * @example {"r_to": "https://example.com", "r_path": "my-link"}
 */
 ...
 * @example {"r_to": "https://new.example.com", "is_active": false}
 */
 ...
 */
export const LinkPathParam = z.object({
  link: z.string().describe("Link ID or r_path slug"),
}).describe("Link path parameter");

/**
 * Link object
 * @example {"id": "a1b2c3d4e5f6g7h8", "r_path": "vn8pm", "r_to": "https://workshop.dastyare.social/v2/summer-2026", "is_active": true, "redirects": "236", "createdAt": "2024-01-15T10:30:00.000Z", "updatedAt": "2024-01-15T10:30:00.000Z"}
 */
...
/**
 * List of links
 * @example [{"id": "a1b2c3d4e5f6g7h8", "r_path": "vn8pm", "r_to": "https://workshop.dastyare.social/v2/summer-2026", "is_active": true, "redirects": "236", "createdAt": "2024-01-15T10:30:00.000Z", "updatedAt": "2024-01-15T10:30:00.000Z"}, {"id": "b2c3d4e5f6g7h8i9", "r_path": "docs", "r_to": "https://docs.dastyare.social", "is_active": true, "redirects": "42", "createdAt": "2024-01-14T15:45:00.000Z", "updatedAt": "2024-01-14T15:45:00.000Z"}]
 */
export const LinkListResponse = z.array(LinkResponse).describe("List of links");
